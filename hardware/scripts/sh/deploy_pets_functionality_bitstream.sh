...
sshpass -p root scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no pets_functionality.bit root@192.168.0.2:/home/root
sshpass -p root ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@192.168.0.2 -t "cat pets_functionality.bit > /dev/xdevcfg"
