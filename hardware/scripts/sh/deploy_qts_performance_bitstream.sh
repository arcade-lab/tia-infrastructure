...
sshpass -p root scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no qts_performance.bit root@192.168.0.2:/home/root
sshpass -p root ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@192.168.0.2 -t "cat qts_performance.bit > /dev/xdevcfg"
