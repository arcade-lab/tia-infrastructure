...
vivado -mode batch -source scripts/tcl/generate_test_system_bitstream_for_functionality.tcl -tclargs block_test_system_top workspace/zynq_project $fpga_platform bts_functionality.bit | tee vivado_build_log.txt
...
echo
echo 'bts_functionality.bit generated successfully.'
echo
