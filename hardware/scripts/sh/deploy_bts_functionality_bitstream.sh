...
sshpass -p root scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no bts_functionality.bit root@192.168.0.2:/home/root
sshpass -p root ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@192.168.0.2 -t "cat bts_functionality.bit > /dev/xdevcfg"
