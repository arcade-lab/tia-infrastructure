...
vivado -mode batch -source scripts/tcl/package_test_system_ip.tcl -tclargs processing_element_test_system workspace/processing_element_test_system src $fpga_platform workspace/processing_element_test_system_ip | tee vivado_packaging_log.txt
...
vivado -mode batch -source scripts/tcl/generate_test_system_bitstream_for_performance.tcl -tclargs pets_performance workspace/zynq_project $fpga_platform workspace/processing_element_test_system_ip processing_element_test_system | tee vivado_build_log.txt
...
echo
echo 'pets_performance.bit generated successfully.'
echo
