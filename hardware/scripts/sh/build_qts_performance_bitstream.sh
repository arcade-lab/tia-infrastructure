...
vivado -mode batch -source scripts/tcl/package_test_system_ip.tcl -tclargs quartet_test_system workspace/quartet_test_system src $fpga_platform workspace/quartet_test_system_ip | tee vivado_packaging_log.txt
...
vivado -mode batch -source scripts/tcl/generate_test_system_bitstream_for_performance.tcl -tclargs qts_performance workspace/zynq_project $fpga_platform workspace/quartet_test_system_ip quartet_test_system | tee vivado_build_log.txt
...
echo
echo 'qts_performance.bit generated successfully.'
echo
